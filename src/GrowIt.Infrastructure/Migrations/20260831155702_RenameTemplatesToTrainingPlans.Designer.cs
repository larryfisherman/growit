...
namespace GrowIt.Infrastructure.Migrations
{
    ...
    [Migration("20260831155702_RenameTemplatesToTrainingPlans")]
    partial class RenameTemplatesToTrainingPlans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrowIt.Domain.Entities.TrainingPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GrowIt.Domain.Entities.TrainingPlanDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GrowIt.Domain.Entities.TrainingPlanDayExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TrainingPlanDayExercises");
                });
            ...
            modelBuilder.Entity("GrowIt.Domain.Entities.TrainingPlanDay", b =>
                {
                    b.HasOne("GrowIt.Domain.Entities.TrainingPlan", "Plan")
                        .WithMany("Days")
            ...
            modelBuilder.Entity("GrowIt.Domain.Entities.TrainingPlanDayExercise", b =>
                {
                    ...
                    b.HasOne("GrowIt.Domain.Entities.TrainingPlanDay", "PlanDay")
                        .WithMany("Exercises")
